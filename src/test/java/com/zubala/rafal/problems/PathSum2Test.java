...
class PathSum2Test {
    ...
    @Test
    public void testPathSumBFS2() {
        Integer[] input1 = { 5,4,8,11,null,13,4,7,2,null,null,5,1 };
        List<List<Integer>> result1 = pathSum2.pathSumBFS(buildBinaryTree(input1), 22);
        ...
        List<List<Integer>> result2 = pathSum2.pathSumBFS(buildBinaryTree(input2), 5);
        assertNotNull(result2);
        assertTrue(result2.isEmpty());
    }

    @Test
    public void testPathSumDFS2() {
        Integer[] input1 = { 5,4,8,11,null,13,4,7,2,null,null,5,1 };
        List<List<Integer>> result1 = pathSum2.pathSumDFS(buildBinaryTree(input1), 22);
        assertNotNull(result1);
        assertEquals(result1.size(), 2);
        Integer[] expected1_1 = {5,4,11,2};
        Integer[] expected1_2 = {5,8,4,5};
        ...
        Integer[] input2 = { 1,2,3 };
        List<List<Integer>> result2 = pathSum2.pathSumDFS(buildBinaryTree(input2), 5);
        assertNotNull(result2);
        assertTrue(result2.isEmpty());
    }
